...
<t:layout>
    <jsp:body>
        <div class="container">
            <div class="row">
                <div class="col">
                    <f:form modelAttribute="orderHeader" method="post">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/orderHeaders/edit/${orderHeader.id}?ref=${util.encodeURL(ref)}">Edit</a>
                            </div>
                        </div>
                    </f:form>
                </div>
