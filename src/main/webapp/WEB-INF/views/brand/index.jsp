            ...
            <div class="row">
                <div class="col">
                    <div class="col-12"><input id="searchbar_toggle" type="checkbox" />
                        <div id="searchbar" class="form-row mb-4">
                            <div class="form-group col-lg-2">
                                <select id="search_col" onchange="searchChange()" class="form-control form-control-sm">
                                    <option value="id" data-type="number" ${param.sc=='id' ? 'selected' : '' }>Brand Id</option>
                                    <option value="name" ${param.sc=='name' ? 'selected' : '' }>Brand Name</option>
                                </select>
                            </div>
                            <div class="form-group col-lg-2">
                        ...
                        <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/brands/create">Create</a>
                    </div>
                    <style>
