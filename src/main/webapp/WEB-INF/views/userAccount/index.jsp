            ...
            <div class="row">
                <div class="col">
                    <div class="col-12"><input id="searchbar_toggle" type="checkbox" />
                        <div id="searchbar" class="form-row mb-4">
                            <div class="form-group col-lg-2">
                                <select id="search_col" onchange="searchChange()" class="form-control form-control-sm">
                                    <option value="id" data-type="number" ${param.sc=='id' ? 'selected' : '' }>User Account Id</option>
                                    <option value="name" ${param.sc=='name' ? 'selected' : '' }>User Account Name</option>
                                    <option value="email" ${param.sc=='email' ? 'selected' : '' }>User Account Email</option>
                                    <option value="active" ${param.sc=='active' ? 'selected' : '' }>User Account Active</option>
                                </select>
                            </div>
                            <div class="form-group col-lg-2">
                        ...
                        <table class="table table-sm table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="${util.getSortClass('email')} d-none d-md-table-cell"><a href="${util.getLink('sort',paging,'email')}">Email</a></th>
                                    <th class="${util.getSortClass('active')}"><a href="${util.getLink('sort',paging,'active')}">Active</a></th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach var="userAccount" items="${userAccounts}">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-secondary" href="${pageContext.request.contextPath}/userAccounts/${userAccount.id}" title="View"><i class="fa fa-eye"></i></a>
                                            <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/userAccounts/edit/${userAccount.id}" title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger" href="${pageContext.request.contextPath}/userAccounts/delete/${userAccount.id}" title="Delete"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        ...
                        <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/userAccounts/create">Create</a>
                    </div>
                    <style>
